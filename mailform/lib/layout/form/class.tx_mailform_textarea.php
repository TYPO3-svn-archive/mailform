...
require_once(t3lib_extMgm::extPath('mailform')."lib/layout/interface/interface.tx_mailform_Iattr_rows.php");
require_once(t3lib_extMgm::extPath('mailform')."lib/layout/interface/interface.tx_mailform_Iattr_cols.php");
...
*/
class tx_mailform_textarea extends tx_mailform_parent implements tx_mailform_I_layout,
																				...
																				tx_mailform_Iattr_rows,
																				tx_mailform_Iattr_cols
																				  {
	...
	public function setRows($rows) {
		$this->addAttribute(new tx_mailform_attr_rows($rows));
	}
	
	public function getRows() {
		return $this->getAttribute('tx_mailform_attr_rows');
	}
	
	public function setCols($cols) {
		$this->addAttribute(new tx_mailform_attr_cols($cols));
	}
	
	public function getCols() {
		return $this->getAttribute('tx_mailform_attr_cols');
	}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailform/lib/layout/form/class.tx_mailform_textarea.php']) {
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailform/lib/layout/form/class.tx_mailform_textarea.php']);
}
?>