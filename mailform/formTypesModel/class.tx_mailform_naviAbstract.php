...
* 
*/
abstract class tx_mailform_naviAbstract extends tx_mailform_formAbstract {

	public function getVarPrefix() {
		global $FE_Handler;
//
		$pref = tx_mailform_pi1::$pageNaviPrefix.'['.$FE_Handler->getMailformUID().']['.$this->getUFID().'][navigation]';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailform/formTypesModel/class.tx_mailform_naviAbstract.php']) {
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailform/formTypesModel/class.tx_mailform_navAbstract.php']);
}